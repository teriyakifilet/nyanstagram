...
ActiveRecord::Schema.define(version: 20_210_517_184_550) do
  ...
  create_table 'relationships', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index ['cat_id'], name: 'index_relationships_on_cat_id'
    t.index %w[user_id cat_id], name: 'index_relationships_on_user_id_and_cat_id', unique: true
  ...
  add_foreign_key 'relationships', 'cats'
